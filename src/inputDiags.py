...
class ExtendedComboBox(QComboBox):
    def __init__(self, parent=None):
        ...
        self.setFocusPolicy(PySide6.QtCore.Qt.StrongFocus)
        self.setEditable(True)

        # add a filter model to filter matching items
        self.pFilterModel = PySide6.QtCore.QSortFilterProxyModel(self)
        self.pFilterModel.setFilterCaseSensitivity(PySide6.QtCore.Qt.CaseInsensitive)
...
class SessionSetterInputDialog(QDialog):
    ...
    def __init__(self, problem_emploi_du_temp, faculty, promo_index, section_index, day_index, slot_index, parent=None):
        ...
        self.buttonBox.setOrientation(PySide6.QtCore.Qt.Horizontal)
